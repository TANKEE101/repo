...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "1417B"
        self.SecretKey: str = "H97GHXJ5634Z5F1MTUA6Z7AIRZQFE6SHC5PMQ33WMEY1TQ6G7Y"
        self.ApiKey: str = "OC|1229768983547417|621c97e4e17531a90a3259aeed135825"
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff00d0>BOOST THE SERVER 1 TIME, OR DONATE 1 DOLLAR FOR THIS PACK!</color>",
        "BundleKioskButton": "<color=#ffffff>THE DRAGON PACK $29.99</color>",
        "BundleKioskSign": "<color=#ffffff>THE DRAGON PURCHASE PACK</color>",
        "BundleLargeSign": "<color=#ffffff>THE DRAGON PACK</color>",
        ...
        "MOTD": "<color=#D4FF00>WELCOME TO COOL TAGG</color>\n<color=#FF0000>MAIN CODES 1-10</color>\n<color=#2BFF00></color>\n<color=#001EFF>FOUNDERS: GRAYSON</color><color=#001EFF>          OWNERS: S4EEPY,GRAYSON</color>\n<color=#08025F>DEVELOPER: S4EEPY</color>\n<color=#1EFF00>JOIN THE DISCORD AT: DISCORD.GG/COOLTAG</color>\n<color=#FFFFFF>-------------------------------------------------------------------------</color>\n<color=#696969>IF U HAVE LOGGED IN, AND DON'T HAVE SOME COSMETICS RESTART IT</color>\n<color=#FFFFFF>         CHANGE YOUR NAME FROM COOL#####</color>",
        "SeasonalStoreBoardSign": "<color=#ff00d0>BOOST THE SERVER FOR BOOSTER STUFF!</color>",
        "TOS_2024.09.20": "DISCORD.GG/SOURTAGG",
        "TOBAlreadyOwnCompTxt": "YOU OWN THE BUNDLE ALREADY! THANK YOU!",
        "TOBAlreadyOwnPurchaseBundle": "SOURTAGG",
